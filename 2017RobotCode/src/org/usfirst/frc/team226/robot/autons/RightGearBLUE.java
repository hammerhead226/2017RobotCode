 ...
 *
 */
public class RightGearBLUE extends CommandGroup {

    public RightGearBLUE() {
        // Add Commands here:
    	...
    	addSequential(new StraightDrive(-73, 0, 0.6, 0.50), 2);
    	addSequential(new PIDTurnToAngle(-65, 0.6), 2.0);
    	addSequential(new StraightDrive(-45, 0, 0.6, 0.50), 2);
