 ...
 *
 */
public class HopperAutonBLUE extends CommandGroup {

    public HopperAutonBLUE() {
        // Add Commands here:
...
//    	addSequential(new cmdPIDTurnToAngleCurved(80, 0.75, 0.73));  
    	...
    	addSequential(new PIDTurnToAngleCurved(37, 0.68, 0.72));
...
//    	addSequential(new cmdPIDDriveInches(25, 0.6), 0.75);
    	...
    	addSequential(new PIDTurnToAngleCurved(70, 0.90, 0.80));
